...
func main() {
	...
	http.HandleFunc("/api/categories/", categoryHandler.HandlerCategoryByID)
	...
	http.HandleFunc("/api/products/", productHandler.HandlerProductByID)
	...
	http.HandleFunc("/api/report/hari-ini", reportHandler.DailyReport)
